...
$root.GetBalancesRequest = (function() {

    /**
     * Properties of a GetBalancesRequest.
     * @exports IGetBalancesRequest
     * @interface IGetBalancesRequest
     * @property {Uint8Array|null} [transactionId] GetBalancesRequest transactionId
     * @property {number|null} [height] GetBalancesRequest height
     * @property {Long|null} [timestamp] GetBalancesRequest timestamp
     * @property {Uint8Array|null} [address] GetBalancesRequest address
     * @property {Uint8Array|null} [assetId] GetBalancesRequest assetId
     */
     ...
     * @constructor
     * @param {IGetBalancesRequest=} [properties] Properties to set
     */
    ...
    /**
     * GetBalancesRequest transactionId.
     * @member {Uint8Array} transactionId
     * @memberof GetBalancesRequest
     * @instance
     */
    GetBalancesRequest.prototype.transactionId = $util.newBuffer([]);

    /**
     * GetBalancesRequest height.
     * @member {number} height
     * @memberof GetBalancesRequest
     * @instance
     */
    GetBalancesRequest.prototype.height = 0;

    /**
     * GetBalancesRequest timestamp.
     * @member {Long} timestamp
     * @memberof GetBalancesRequest
     * @instance
     */
    GetBalancesRequest.prototype.timestamp = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

    /**
     * GetBalancesRequest address.
     * @member {Uint8Array} address
     * @memberof GetBalancesRequest
     * @instance
     */
    GetBalancesRequest.prototype.address = $util.newBuffer([]);

    /**
     * GetBalancesRequest assetId.
     * @member {Uint8Array} assetId
     * @memberof GetBalancesRequest
     * @instance
     */
    GetBalancesRequest.prototype.assetId = $util.newBuffer([]);
     ...
     * @static
     * @param {IGetBalancesRequest=} [properties] Properties to set
     * @returns {GetBalancesRequest} GetBalancesRequest instance
     */
    ...
    /**
     * Encodes the specified GetBalancesRequest message. Does not implicitly {@link GetBalancesRequest.verify|verify} messages.
     * @function encode
     * @memberof GetBalancesRequest
     * @static
     * @param {IGetBalancesRequest} message GetBalancesRequest message or plain object to encode
    ...
    /**
     * Encodes the specified GetBalancesRequest message, length delimited. Does not implicitly {@link GetBalancesRequest.verify|verify} messages.
     ...
     * @returns {GetBalancesRequest} GetBalancesRequest
    ...
    GetBalancesRequest.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GetBalancesRequest();
    ...
    GetBalancesRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.GetBalancesRequest)
            return object;
        var message = new $root.GetBalancesRequest();
     ...
     * @memberof GetBalancesRequest
     * @static
     * @param {GetBalancesRequest} message GetBalancesRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    GetBalancesRequest.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
...
$root.Balances = (function() {
    ...
    /**
     * Callback as used by {@link Balances#getBalances}.
     * @memberof Balances
     ...
     * @memberof Balances
     * @instance
     * @param {IGetBalancesRequest} request GetBalancesRequest message or plain object
     * @param {Balances.GetBalancesCallback} callback Node-style callback called with the error, if any, and Balance
     * @returns {undefined}
     * @variation 1
     */
    Object.defineProperty(Balances.prototype.getBalances = function getBalances(request, callback) {
        return this.rpcCall(getBalances, $root.GetBalancesRequest, $root.Balance, request, callback);
...
$root.ByTransactionRequest = (function() {

    /**
     * Properties of a ByTransactionRequest.
     * @exports IByTransactionRequest
     * @interface IByTransactionRequest
     * @property {Uint8Array|null} [transactionId] ByTransactionRequest transactionId
     */

    /**
     * Constructs a new ByTransactionRequest.
     * @exports ByTransactionRequest
     * @classdesc Represents a ByTransactionRequest.
     * @implements IByTransactionRequest
     * @constructor
     * @param {IByTransactionRequest=} [properties] Properties to set
     */
    function ByTransactionRequest(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
    ...
    /**
     * ByTransactionRequest transactionId.
     * @member {Uint8Array} transactionId
     * @memberof ByTransactionRequest
     * @instance
     */
    ByTransactionRequest.prototype.transactionId = $util.newBuffer([]);

    /**
     * Creates a new ByTransactionRequest instance using the specified properties.
     * @function create
     * @memberof ByTransactionRequest
     * @static
     * @param {IByTransactionRequest=} [properties] Properties to set
     * @returns {ByTransactionRequest} ByTransactionRequest instance
     */
    ByTransactionRequest.create = function create(properties) {
        return new ByTransactionRequest(properties);
    };

    /**
     * Encodes the specified ByTransactionRequest message. Does not implicitly {@link ByTransactionRequest.verify|verify} messages.
     * @function encode
     * @memberof ByTransactionRequest
     * @static
     * @param {IByTransactionRequest} message ByTransactionRequest message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ByTransactionRequest.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.transactionId != null && message.hasOwnProperty("transactionId"))
            writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.transactionId);
    ...
    /**
     * Encodes the specified ByTransactionRequest message, length delimited. Does not implicitly {@link ByTransactionRequest.verify|verify} messages.
     * @function encodeDelimited
     * @memberof ByTransactionRequest
     * @static
     * @param {IByTransactionRequest} message ByTransactionRequest message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ByTransactionRequest.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a ByTransactionRequest message from the specified reader or buffer.
     * @function decode
     * @memberof ByTransactionRequest
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ByTransactionRequest} ByTransactionRequest
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ByTransactionRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ByTransactionRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    /**
     * Decodes a ByTransactionRequest message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof ByTransactionRequest
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ByTransactionRequest.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a ByTransactionRequest message.
     * @function verify
     * @memberof ByTransactionRequest
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ByTransactionRequest.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.transactionId != null && message.hasOwnProperty("transactionId"))
            if (!(message.transactionId && typeof message.transactionId.length === "number" || $util.isString(message.transactionId)))
    ...
    /**
     * Creates a ByTransactionRequest message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof ByTransactionRequest
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {ByTransactionRequest} ByTransactionRequest
     */
    ByTransactionRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.ByTransactionRequest)
            return object;
        var message = new $root.ByTransactionRequest();
        if (object.transactionId != null)
            if (typeof object.transactionId === "string")
                $util.base64.decode(object.transactionId, message.transactionId = $util.newBuffer($util.base64.length(object.transactionId)), 0);
            else if (object.transactionId.length)
    ...
    /**
     * Creates a plain object from a ByTransactionRequest message. Also converts values to other types if specified.
     * @function toObject
     * @memberof ByTransactionRequest
     * @static
     * @param {ByTransactionRequest} message ByTransactionRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ByTransactionRequest.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults)
    ...
    /**
     * Converts this ByTransactionRequest to JSON.
     * @function toJSON
     * @memberof ByTransactionRequest
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    ByTransactionRequest.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    return ByTransactionRequest;
})();

$root.ByAddressRequest = (function() {

    /**
     * Properties of a ByAddressRequest.
     * @exports IByAddressRequest
     * @interface IByAddressRequest
     * @property {number|null} [height] ByAddressRequest height
     * @property {Long|null} [timestamp] ByAddressRequest timestamp
     * @property {Uint8Array|null} [address] ByAddressRequest address
     * @property {number|null} [limit] ByAddressRequest limit
     * @property {Uint8Array|null} [after] ByAddressRequest after
     * @property {string|null} [key] ByAddressRequest key
     * @property {number|null} [type] ByAddressRequest type
     * @property {Long|null} [intValue] ByAddressRequest intValue
     * @property {boolean|null} [boolValue] ByAddressRequest boolValue
     * @property {Uint8Array|null} [binaryValue] ByAddressRequest binaryValue
     * @property {string|null} [stringValue] ByAddressRequest stringValue
     */

    /**
     * Constructs a new ByAddressRequest.
     * @exports ByAddressRequest
     * @classdesc Represents a ByAddressRequest.
     * @implements IByAddressRequest
     * @constructor
     * @param {IByAddressRequest=} [properties] Properties to set
     */
    function ByAddressRequest(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
    ...
    /**
     * ByAddressRequest height.
     * @member {number} height
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.height = 0;

    /**
     * ByAddressRequest timestamp.
     * @member {Long} timestamp
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.timestamp = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

    /**
     * ByAddressRequest address.
     * @member {Uint8Array} address
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.address = $util.newBuffer([]);

    /**
     * ByAddressRequest limit.
     * @member {number} limit
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.limit = 0;

    /**
     * ByAddressRequest after.
     * @member {Uint8Array} after
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.after = $util.newBuffer([]);

    /**
     * ByAddressRequest key.
     * @member {string} key
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.key = "";

    /**
     * ByAddressRequest type.
     * @member {number} type
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.type = 0;

    /**
     * ByAddressRequest intValue.
     * @member {Long} intValue
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.intValue = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

    /**
     * ByAddressRequest boolValue.
     * @member {boolean} boolValue
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.boolValue = false;

    /**
     * ByAddressRequest binaryValue.
     * @member {Uint8Array} binaryValue
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.binaryValue = $util.newBuffer([]);

    /**
     * ByAddressRequest stringValue.
     * @member {string} stringValue
     * @memberof ByAddressRequest
     * @instance
     */
    ByAddressRequest.prototype.stringValue = "";

    // OneOf field names bound to virtual getters and setters
    var $oneOfFields;

    /**
     * ByAddressRequest value.
     * @member {"intValue"|"boolValue"|"binaryValue"|"stringValue"|undefined} value
     * @memberof ByAddressRequest
     * @instance
     */
    Object.defineProperty(ByAddressRequest.prototype, "value", {
        get: $util.oneOfGetter($oneOfFields = ["intValue", "boolValue", "binaryValue", "stringValue"]),
        set: $util.oneOfSetter($oneOfFields)
    });

    /**
     * Creates a new ByAddressRequest instance using the specified properties.
     * @function create
     * @memberof ByAddressRequest
     * @static
     * @param {IByAddressRequest=} [properties] Properties to set
     * @returns {ByAddressRequest} ByAddressRequest instance
     */
    ByAddressRequest.create = function create(properties) {
        return new ByAddressRequest(properties);
    };

    /**
     * Encodes the specified ByAddressRequest message. Does not implicitly {@link ByAddressRequest.verify|verify} messages.
     * @function encode
     * @memberof ByAddressRequest
     * @static
     * @param {IByAddressRequest} message ByAddressRequest message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ByAddressRequest.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.height != null && message.hasOwnProperty("height"))
    ...
    /**
     * Encodes the specified ByAddressRequest message, length delimited. Does not implicitly {@link ByAddressRequest.verify|verify} messages.
     * @function encodeDelimited
     * @memberof ByAddressRequest
     * @static
     * @param {IByAddressRequest} message ByAddressRequest message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ByAddressRequest.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a ByAddressRequest message from the specified reader or buffer.
     * @function decode
     * @memberof ByAddressRequest
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ByAddressRequest} ByAddressRequest
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ByAddressRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ByAddressRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    /**
     * Decodes a ByAddressRequest message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof ByAddressRequest
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ByAddressRequest.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a ByAddressRequest message.
     * @function verify
     * @memberof ByAddressRequest
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ByAddressRequest.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        var properties = {};
        if (message.height != null && message.hasOwnProperty("height"))
    ...
    /**
     * Creates a ByAddressRequest message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof ByAddressRequest
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {ByAddressRequest} ByAddressRequest
     */
    ByAddressRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.ByAddressRequest)
            return object;
        var message = new $root.ByAddressRequest();
        if (object.height != null)
            message.height = object.height | 0;
        if (object.timestamp != null)
            if ($util.Long)
    ...
    /**
     * Creates a plain object from a ByAddressRequest message. Also converts values to other types if specified.
     * @function toObject
     * @memberof ByAddressRequest
     * @static
     * @param {ByAddressRequest} message ByAddressRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ByAddressRequest.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
    ...
    /**
     * Converts this ByAddressRequest to JSON.
     * @function toJSON
     * @memberof ByAddressRequest
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    ByAddressRequest.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    return ByAddressRequest;
})();
...
$root.SearchRequest = (function() {
     ...
     * @property {number|null} [height] SearchRequest height
     * @property {Long|null} [timestamp] SearchRequest timestamp
     * @property {number|null} [limit] SearchRequest limit
     * @property {Uint8Array|null} [after] SearchRequest after
     * @property {string|null} [key] SearchRequest key
     * @property {number|null} [type] SearchRequest type
     * @property {Long|null} [intValue] SearchRequest intValue
     * @property {boolean|null} [boolValue] SearchRequest boolValue
     * @property {Uint8Array|null} [binaryValue] SearchRequest binaryValue
     * @property {string|null} [stringValue] SearchRequest stringValue
     */
     ...
     * @instance
     */
    SearchRequest.prototype.height = 0;
     ...
     * @instance
     */
    SearchRequest.prototype.timestamp = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
     ...
     * @instance
     */
    SearchRequest.prototype.after = $util.newBuffer([]);
    ...
    /**
     * SearchRequest intValue.
     * @member {Long} intValue
     * @memberof SearchRequest
     * @instance
     */
    SearchRequest.prototype.intValue = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

    /**
     * SearchRequest boolValue.
     * @member {boolean} boolValue
     * @memberof SearchRequest
     * @instance
     */
    SearchRequest.prototype.boolValue = false;

    /**
     * SearchRequest binaryValue.
     * @member {Uint8Array} binaryValue
     * @memberof SearchRequest
     * @instance
     */
    SearchRequest.prototype.binaryValue = $util.newBuffer([]);

    /**
     * SearchRequest stringValue.
     * @member {string} stringValue
     * @memberof SearchRequest
     * @instance
     */
    SearchRequest.prototype.stringValue = "";
     ...
     * @instance
     */
    Object.defineProperty(SearchRequest.prototype, "value", {
        get: $util.oneOfGetter($oneOfFields = ["intValue", "boolValue", "binaryValue", "stringValue"]),
        set: $util.oneOfSetter($oneOfFields)
    });
...
$root.DataEntries = (function() {
     ...
     * @memberof DataEntries
     * @instance
     * @param {IByTransactionRequest} request ByTransactionRequest message or plain object
    ...
    Object.defineProperty(DataEntries.prototype.byTransaction = function byTransaction(request, callback) {
        return this.rpcCall(byTransaction, $root.ByTransactionRequest, $root.DataEntryResponse, request, callback);
     ...
     * @memberof DataEntries
     * @instance
     * @param {IByAddressRequest} request ByAddressRequest message or plain object
    ...
    Object.defineProperty(DataEntries.prototype.byAddress = function byAddress(request, callback) {
        return this.rpcCall(byAddress, $root.ByAddressRequest, $root.DataEntryResponse, request, callback);
    ...
    Object.defineProperty(DataEntries.prototype.search = function search(request, callback) {
        return this.rpcCall(search, $root.SearchRequest, $root.DataEntryResponse, request, callback);
    }, "name", { value: "Search" });
