...
proto.Amount = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.Amount.oneofGroups_);
};
 ...
 * @const
 */
proto.Amount.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.Amount.AmountCase = {
  AMOUNT_NOT_SET: 0,
  WAVES_AMOUNT: 1,
  ASSET_AMOUNT: 2
};
...
/**
 * @return {proto.Amount.AmountCase}
 */
proto.Amount.prototype.getAmountCase = function() {
  return /** @type {proto.Amount.AmountCase} */(jspb.Message.computeOneofCase(this, proto.Amount.oneofGroups_[0]));
};
...
proto.Amount.toObject = function(includeInstance, msg) {
  var f, obj = {
    wavesAmount: jspb.Message.getFieldWithDefault(msg, 1, 0),
...
/**
 * optional int64 waves_amount = 1;
 * @return {number}
 */
proto.Amount.prototype.getWavesAmount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.Amount.prototype.setWavesAmount = function(value) {
  jspb.Message.setOneofField(this, 1, proto.Amount.oneofGroups_[0], value);
};


proto.Amount.prototype.clearWavesAmount = function() {
  jspb.Message.setOneofField(this, 1, proto.Amount.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.Amount.prototype.hasWavesAmount = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional AssetAmount asset_amount = 2;
 * @return {?proto.AssetAmount}
 */
proto.Amount.prototype.getAssetAmount = function() {
  return /** @type{?proto.AssetAmount} */ (
    jspb.Message.getWrapperField(this, proto.AssetAmount, 2));
};


/** @param {?proto.AssetAmount|undefined} value */
proto.Amount.prototype.setAssetAmount = function(value) {
  jspb.Message.setOneofWrapperField(this, 2, proto.Amount.oneofGroups_[0], value);
};


proto.Amount.prototype.clearAssetAmount = function() {
 ...
 * @return {boolean}
 */
proto.Amount.prototype.hasAssetAmount = function() {
 ...
 * @const
 */
proto.Transaction.oneofGroups_ = [[101,102,103,104,105,106,107,108,109,110,111,112,113,114,115]];
 ...
 * @return {string}
 */
proto.MassTransferTransactionData.prototype.getAssetId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getAssetId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.MassTransferTransactionData.prototype.getAssetId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getAssetId()));
};
...
proto.ExchangeTransactionData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.ExchangeTransactionData.oneofGroups_);
};
 ...
 * @const
 */
proto.ExchangeTransactionData.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.ExchangeTransactionData.OrdersCase = {
  ORDERS_NOT_SET: 0,
  BUY_SELL_ORDERS: 1,
...
/**
 * @return {proto.ExchangeTransactionData.OrdersCase}
 */
proto.ExchangeTransactionData.prototype.getOrdersCase = function() {
  return /** @type {proto.ExchangeTransactionData.OrdersCase} */(jspb.Message.computeOneofCase(this, proto.ExchangeTransactionData.oneofGroups_[0]));
};
...
proto.ExchangeTransactionData.toObject = function(includeInstance, msg) {
  var f, obj = {
    buySellOrders: (f = msg.getBuySellOrders()) && proto.ExchangeTransactionData.BuySellOrders.toObject(includeInstance, f),
    makerTakerOrders: (f = msg.getMakerTakerOrders()) && proto.ExchangeTransactionData.MakerTakerOrders.toObject(includeInstance, f),
    amount: jspb.Message.getFieldWithDefault(msg, 3, 0),
    price: jspb.Message.getFieldWithDefault(msg, 4, 0),
    buyMatcherFee: jspb.Message.getFieldWithDefault(msg, 5, 0),
    sellMatcherFee: jspb.Message.getFieldWithDefault(msg, 6, 0)
  };
...
proto.ExchangeTransactionData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.ExchangeTransactionData.BuySellOrders;
      reader.readMessage(value,proto.ExchangeTransactionData.BuySellOrders.deserializeBinaryFromReader);
      msg.setBuySellOrders(value);
      break;
    case 2:
      var value = new proto.ExchangeTransactionData.MakerTakerOrders;
      reader.readMessage(value,proto.ExchangeTransactionData.MakerTakerOrders.deserializeBinaryFromReader);
      msg.setMakerTakerOrders(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readInt64());
      msg.setAmount(value);
...
proto.ExchangeTransactionData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBuySellOrders();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.ExchangeTransactionData.BuySellOrders.serializeBinaryToWriter
    );
  }
  f = message.getMakerTakerOrders();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.ExchangeTransactionData.MakerTakerOrders.serializeBinaryToWriter
    );
  }
  f = message.getAmount();
  if (f !== 0) {
...
/**
 * optional BuySellOrders buy_sell_orders = 1;
 * @return {?proto.ExchangeTransactionData.BuySellOrders}
 */
proto.ExchangeTransactionData.prototype.getBuySellOrders = function() {
  return /** @type{?proto.ExchangeTransactionData.BuySellOrders} */ (
    jspb.Message.getWrapperField(this, proto.ExchangeTransactionData.BuySellOrders, 1));
};


/** @param {?proto.ExchangeTransactionData.BuySellOrders|undefined} value */
proto.ExchangeTransactionData.prototype.setBuySellOrders = function(value) {
  jspb.Message.setOneofWrapperField(this, 1, proto.ExchangeTransactionData.oneofGroups_[0], value);
};


proto.ExchangeTransactionData.prototype.clearBuySellOrders = function() {
  this.setBuySellOrders(undefined);
};
 ...
 * @return {boolean}
 */
proto.ExchangeTransactionData.prototype.hasBuySellOrders = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional MakerTakerOrders maker_taker_orders = 2;
 * @return {?proto.ExchangeTransactionData.MakerTakerOrders}
 */
proto.ExchangeTransactionData.prototype.getMakerTakerOrders = function() {
  return /** @type{?proto.ExchangeTransactionData.MakerTakerOrders} */ (
    jspb.Message.getWrapperField(this, proto.ExchangeTransactionData.MakerTakerOrders, 2));
};


/** @param {?proto.ExchangeTransactionData.MakerTakerOrders|undefined} value */
proto.ExchangeTransactionData.prototype.setMakerTakerOrders = function(value) {
  jspb.Message.setOneofWrapperField(this, 2, proto.ExchangeTransactionData.oneofGroups_[0], value);
};


proto.ExchangeTransactionData.prototype.clearMakerTakerOrders = function() {
  this.setMakerTakerOrders(undefined);
};
 ...
 * @return {boolean}
 */
proto.ExchangeTransactionData.prototype.hasMakerTakerOrders = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
/**
 * optional int64 buy_matcher_fee = 5;
 * @return {number}
 */
...
/**
 * optional int64 sell_matcher_fee = 6;
 * @return {number}
 */
