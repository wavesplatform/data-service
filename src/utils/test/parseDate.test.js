...
describe('parseDate', () => {
  it('works with positive numberish string', () => {
    ...
    const expectedValue = new Date(1525132800000).toISOString();
  ...
  it('works with timestamp', () => {
    ...
    const expectedValue = new Date('2018-05-01T00:00:00.000Z').toISOString();
  ...
  it('works with short timestamp in ru locale', () => {
    ...
    const expectedValue = new Date('2018-01-04T21:00:00.000Z').toISOString(); // UTC
