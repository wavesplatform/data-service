...
const selectVolumeWavesFromPairs = pg({ d: 'pairs' })
  .columns([pg.raw('p.volume * d.weighted_average_price')])
...
const selectPairs = pg
  ...
  .columns(
    ...
    {
      volume_waves: pg.raw(
        `coalesce(volume_waves, (${selectVolumeWavesFromPairs.toString()}))`
      ),
    }
  );
