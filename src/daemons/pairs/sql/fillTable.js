...
const selectVolumeWavesFromTempPairs = pg({ d: 'temp_pairs' })
...
const selectTempPairs = pg
  ...
  .columns(
    ...
    {
      volume_waves: pg.raw(
        `coalesce(volume_waves, (${selectVolumeWavesFromTempPairs.toString()}))`
      ),
    }
  );
console.log(
